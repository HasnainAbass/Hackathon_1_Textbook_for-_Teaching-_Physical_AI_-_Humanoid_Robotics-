...
user: user
command: /sp.plan
labels: [planning,ros2,documentation,docusaurus,education]
links:
...
1. Install and initialize Docusaurus; configure docs structure and sidebar navigation.
2. Create Module 1 documentation with three chapters:
   - ROS 2 Foundations
   - Python AI Agents with rclpy
   - Humanoid Representation with URDF
3. Ensure all documentation files are written in `.md` format.
