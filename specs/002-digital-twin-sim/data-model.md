---
title: Data Model for Module 2: The Digital Twin (Gazebo & Unity)
---
...
This document defines the conceptual data model for the educational content in Module 2: The Digital Twin (Gazebo & Unity). Since this is a documentation module, the "data" consists of the educational content structure and relationships.
...
- **Attributes**:
  - title: string (e.g., "Physics-Based Simulation with Gazebo")
...
- **Attributes**:
  - title: string (e.g., "Gazebo Physics: Gravity and Collisions")
